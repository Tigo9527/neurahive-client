...
import (
	...
	"github.com/Conflux-Chain/neurahive-client/file/merkle"
...
func (uploader *Uploader) Upload(filename string, option ...UploadOption) error {
	...
	if info != nil && info.Finalized {
		if !opt.Force {
			return errors.New("File already exists on Neurahive network")
		}
